                    ...
                    if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $tujuan)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $isi)){
                                $_SESSION['isik'] = 'Form Lampiran hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), kurung(), underscore(_), dan(&) persen(%) dan at(@)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {
                                ...
                                if(!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)){
                                    ...
                                    if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                            $_SESSION['keterangank'] = 'Form Pejabat Penanda Tangan hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan kurung()';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="kode" type="text" class="validate" name="kode" value="<?php echo $kode ;?>" required>
                                    ...
                                    ?>
                                <label for="kode">Kode Klasifikasi (Masukan Angka 0 untuk memilih nya)</label>
                            </div>
                            <div class="input-field col s6">
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="keterangan" type="text" class="validate" name="keterangan" value="<?php echo $keterangan ;?>" required>
                                    ...
                                    ?>
                                <label for="keterangan">Pejabat Penanda Tangan</label>
                            </div>
                            <div class="input-field col s6">
