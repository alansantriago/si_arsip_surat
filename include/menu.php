...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">mail</i>Sistem Informasi</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">assignment</i> Laporan Surat</a>
                        <div class="collapsible-body">
                            <ul>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            ...
            ?>
            <li><a class="dropdown-button" href="#!" data-activates="agenda">Laporan Surat <i class="material-icons md-18">arrow_drop_down</i></a></li>
