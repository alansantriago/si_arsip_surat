...
<head>
    ...
    <title>Login - Pelayanan dan Pengarsipan Surat</title>
    ...
    <style type="text/css">
        ...
        .bg::before {
            content: '';
            background-image: url('./asset/img/bckg1.jpg');
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title"><b>Pelayanan dan Pengarsipan Surat</b></h5>
